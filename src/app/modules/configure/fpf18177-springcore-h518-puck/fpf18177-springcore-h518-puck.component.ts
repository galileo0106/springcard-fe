...
import { Fpf18177SpringcoreH518Puck_FieldsDefinition } from './fpf18177-springcore-h518-puck-fields-definition';
import { Fpf18177SpringcoreH518Puck_getFieldsList } from './fpf18177-springcore-h518-puck-fields-list';
import { Fpf18177_springcore_h518_puckFormGroup } from './fpf18177-springcore-h518-puck-form-group';

@Component({
  selector: 'app-fpf18177-springcore-h518-puck',
  templateUrl: './fpf18177-springcore-h518-puck.component.html',
  styleUrls: ['../sharedstyles.css'],
})
export class Fpf18177SpringcoreH518PuckComponent extends DeviceComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    super.ngOnInit();
    this.setChildComponentName('Fpf18177SpringcoreH518PuckComponent');
    this.valdemortConfig.displayMode = DisplayMode.ONE;
    this.valdemortConfig.shouldDisplayErrors = () => true;
    this.currentTitleService.changeTitle('Configuration - Puck One');
    this.setDeviceInformation('springcore/h518/puck', 'FPF18177', "Puck One");
    this.searchRouteParameters(); // doit se trouver AVANT this.createConfigurationObjects() - permet la création du projet
    // prettier-ignore
    this.createConfigurationObjects(Fpf18177_springcore_h518_puckFormGroup, Fpf18177SpringcoreH518Puck_FieldsDefinition, Fpf18177SpringcoreH518Puck_getFieldsList);
