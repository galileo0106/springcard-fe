...
import { Fpf18175SpringcoreH518Puck_FieldsDefinition } from './fpf18175-springcore-h518-puck-fields-definition';
import { Fpf18175SpringcoreH518Puck_getFieldsList } from './fpf18175-springcore-h518-puck-fields-list';
import { Fpf18175_springcore_h518_puckFormGroup } from './fpf18175-springcore-h518-puck-form-group';

@Component({
  selector: 'app-fpf18175-springcore-h518-puck',
  templateUrl: './fpf18175-springcore-h518-puck.component.html',
  styleUrls: ['../sharedstyles.css'],
})
export class Fpf18175SpringcoreH518PuckComponent extends DeviceComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    super.ngOnInit();
    this.setChildComponentName('Fpf18175SpringcoreH518PuckComponent');
    this.valdemortConfig.displayMode = DisplayMode.ONE;
    this.valdemortConfig.shouldDisplayErrors = () => true;
    this.currentTitleService.changeTitle('Configuration - Puck Base');
    this.setDeviceInformation('springcore/h518/puck', 'FPF18175', "Puck Base");
    this.searchRouteParameters(); // doit se trouver AVANT this.createConfigurationObjects() - permet la création du projet
    // prettier-ignore
    this.createConfigurationObjects(Fpf18175_springcore_h518_puckFormGroup, Fpf18175SpringcoreH518Puck_FieldsDefinition, Fpf18175SpringcoreH518Puck_getFieldsList);
