...
import { Fpf18170SpringcoreH518Puck_FieldsDefinition } from './fpf18170-springcore-h518-puck-fields-definition';
import { Fpf18170SpringcoreH518Puck_getFieldsList } from './fpf18170-springcore-h518-puck-fields-list';
import { Fpf18170_springcore_h518_puckFormGroup } from './fpf18170-springcore-h518-puck-form-group';

@Component({
  selector: 'app-fpf18170-springcore-h518-puck',
  templateUrl: './fpf18170-springcore-h518-puck.component.html',
  styleUrls: ['../sharedstyles.css'],
})
export class Fpf18170SpringcoreH518PuckComponent extends DeviceComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    super.ngOnInit();
    this.setChildComponentName('Fpf18170SpringcoreH518PuckComponent');
    this.valdemortConfig.displayMode = DisplayMode.ONE;
    this.valdemortConfig.shouldDisplayErrors = () => true;
    this.currentTitleService.changeTitle('Configuration - Puck Ultimate');
    this.setDeviceInformation('springcore/h518/puck', 'FPF18170', "Puck Ultimate");
    this.searchRouteParameters(); // doit se trouver AVANT this.createConfigurationObjects() - permet la création du projet
    // prettier-ignore
    this.createConfigurationObjects(Fpf18170_springcore_h518_puckFormGroup, Fpf18170SpringcoreH518Puck_FieldsDefinition, Fpf18170SpringcoreH518Puck_getFieldsList);
