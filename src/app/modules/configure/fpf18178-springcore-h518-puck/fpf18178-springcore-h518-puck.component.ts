...
import { Fpf18178SpringcoreH518Puck_FieldsDefinition } from './fpf18178-springcore-h518-puck-fields-definition';
import { Fpf18178SpringcoreH518Puck_getFieldsList } from './fpf18178-springcore-h518-puck-fields-list';
import { Fpf18178_springcore_h518_puckFormGroup } from './fpf18178-springcore-h518-puck-form-group';

@Component({
  selector: 'app-fpf18178-springcore-h518-puck',
  templateUrl: './fpf18178-springcore-h518-puck.component.html',
  styleUrls: ['../sharedstyles.css'],
})
export class Fpf18178SpringcoreH518PuckComponent extends DeviceComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    super.ngOnInit();
    this.setChildComponentName('Fpf18178SpringcoreH518PuckComponent');
    this.valdemortConfig.displayMode = DisplayMode.ONE;
    this.valdemortConfig.shouldDisplayErrors = () => true;
    this.currentTitleService.changeTitle('Configuration - Puck Point');
    this.setDeviceInformation('springcore/h518/puck', 'FPF18178', "Puck Point");
    this.searchRouteParameters(); // doit se trouver AVANT this.createConfigurationObjects() - permet la création du projet
    // prettier-ignore
    this.createConfigurationObjects(Fpf18178_springcore_h518_puckFormGroup, Fpf18178SpringcoreH518Puck_FieldsDefinition, Fpf18178SpringcoreH518Puck_getFieldsList);
